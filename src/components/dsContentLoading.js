/**
 * @ngdoc directive
 * @name CoreModule.directive:dsContentLoading
 * @restrict A
 *
 * @description
 *  disable container while a variable is true
 *
 * @example
 * <div ds-content-loading="isLoading"></div>
 */

export function dsContentLoading() {
    return {
        restrict: 'A',
